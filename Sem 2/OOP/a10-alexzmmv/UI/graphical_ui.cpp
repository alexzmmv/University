...
void Graphical_ui::buttonConnect() {
    ...
    //QObject::connect(this->undoButton, &QPushButton::clicked, this, &Graphical_ui::undoHandler);
    //QObject::connect(this->redoButton, &QPushButton::clicked, this, &Graphical_ui::redoHandler);
    this->undoShortcut = new QShortcut(QKeySequence(QKeySequence(tr("Ctrl+z"))), this);
    this->redoShortcut1 = new QShortcut(QKeySequence(tr("Ctrl+y")), this);
    this->redoShortcut2=  new QShortcut(QKeySequence(tr("Ctrl+Shift+z")), this);
    this->deleteShortcut = new QShortcut(QKeySequence(tr("d")), this);
    QObject::connect(this->undoShortcut, &QShortcut::activated, this, &Graphical_ui::undoHandler);
    QObject::connect(this->redoShortcut1, &QShortcut::activated, this, &Graphical_ui::redoHandler);
    QObject::connect(this->redoShortcut2, &QShortcut::activated, this, &Graphical_ui::redoHandler);
    QObject::connect(this->redoButton, &QPushButton::clicked, this, &Graphical_ui::redoHandler);
    QObject::connect(this->undoButton, &QPushButton::clicked, this, &Graphical_ui::undoHandler);
    QObject::connect(this->deleteShortcut, &QShortcut::activated, this, &Graphical_ui::deleteAdminButtonHandler);
    QObject::connect(this->showViewButton, &QPushButton::clicked, this, &Graphical_ui::showViewButtonHandler);
}
...
void Graphical_ui::buildGUI() {
    ...
    inputLayout->addWidget(this->userModeButton, 8, 1);
    inputLayout->addWidget(this->openStatisticsButton,9,1);
    inputLayout->addLayout(undoRedoLayout,7,1);
    this->showViewButton = new QPushButton{"Show View"};
    inputLayout->addWidget(this->showViewButton, 10, 1);
...
void Graphical_ui::userModeButtonHandler() {
    try {
        ...
        auto *userModeList = new QListWidget{userModeWidget};
...
void Graphical_ui::showViewButtonHandler() {
    auto *view = new UserPlannerView{this};
    auto* viewWidget = new QWidget{this, Qt::Window};
    auto* viewLayout = new QVBoxLayout{viewWidget};
    viewLayout->addWidget(view);
    viewWidget->setWindowTitle("User Planner");
    viewWidget->setMinimumWidth(1000);
    viewWidget->setMinimumHeight(500);
    view->setActivities(this->controller->getUserActivities());
    viewWidget->show();
}

UserPlannerView::UserPlannerView(QWidget *parent)
        : QWidget(parent), model(new UserPlannerModelForGui(this)) {
...
void UserPlannerView::setActivities(const std::vector<Activity>& activities) {
